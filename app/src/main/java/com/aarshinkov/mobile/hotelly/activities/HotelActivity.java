...
import static com.aarshinkov.mobile.hotelly.utils.Api.getRetrofit;
...
public class HotelActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        hotelCheckBtn = findViewById(R.id.hotelCheckBtn);
        ...
        hotelCheckBtn.setOnClickListener(v -> {
